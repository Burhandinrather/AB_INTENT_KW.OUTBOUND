...
source_file_loc = (r"C:\Work\Audience Bridge\Round 2\Source\Maersk\Maersk Tracked TA List.csv")
ext_file_location = (r"C:\Work\Audience Bridge\Round 2\Imported\Maersk\Maersk Tracked TA List_updated.csv")
...
df.columns = ['COMPANY_NAME', 'WEBSITE', 'COUNTRY']


table_name = "maersk_ta_list"
