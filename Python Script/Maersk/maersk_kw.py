...
source_file_loc = (r"C:\Work\Audience Bridge\Round 2\Source\Maersk\Maersk KW List.csv")
ext_file_location = (r"C:\Work\Audience Bridge\Round 2\Imported\Maersk\Maersk KW List_updated.csv")
