...
source_file_loc = (r"C:\Work\Audience Bridge\Round 2\Source\EY\EY IC - TA List.csv")
ext_file_location = (r"C:\Work\Audience Bridge\Round 2\Imported\EY\EY IC - TA List_updated.csv")
