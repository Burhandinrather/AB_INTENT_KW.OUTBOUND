...
source_file_loc = (r"C:\Work\Audience Bridge\Round 2\Source\EY\EY TLSA - KW list.csv")
ext_file_location = (r"C:\Work\Audience Bridge\Round 2\Imported\EY\EY TLSA - KW list_updated.csv")
